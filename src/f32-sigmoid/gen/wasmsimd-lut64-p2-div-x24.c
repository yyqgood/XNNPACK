    ...
    const void* params) XNN_DISABLE_TSAN
{
  ...
  for (; n >= 24 * sizeof(float); n -= 24 * sizeof(float)) {
    ...
    const v128_t vl0   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidx01));
    const v128_t vl2 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidx23));
    const v128_t vl1 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidx01 >> 32)));
    const v128_t vl3 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidx23 >> 32)));
    ...
    const v128_t vl4   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidx45));
    const v128_t vl6 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidx67));
    const v128_t vl5 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidx45 >> 32)));
    const v128_t vl7 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidx67 >> 32)));
    ...
    const v128_t vl8   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidx89));
    const v128_t vlA = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxAB));
    const v128_t vl9 = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidx89 >> 32)));
    const v128_t vlB = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxAB >> 32)));
    ...
    const v128_t vlC   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxCD));
    const v128_t vlE = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxEF));
    const v128_t vlD = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxCD >> 32)));
    const v128_t vlF = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxEF >> 32)));
    ...
    const v128_t vlG   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxGH));
    const v128_t vlI = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxIJ));
    const v128_t vlH = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxGH >> 32)));
    const v128_t vlJ = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxIJ >> 32)));
    ...
    const v128_t vlK   = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxKL));
    const v128_t vlM = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) vidxMN));
    const v128_t vlL = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxKL >> 32)));
    const v128_t vlN = __builtin_wasm_load32_zero((int*) ((uintptr_t) xnn_table_exp2_k_over_64 + (uint32_t) (vidxMN >> 32)));
    const v128_t vlKL = wasm_v32x4_shuffle(vlK, vlL, 0, 4, 1, 5);
    const v128_t vlMN = wasm_v32x4_shuffle(vlM, vlN, 0, 4, 1, 5);
    const v128_t vlKLMN = wasm_v32x4_shuffle(vlKL, vlMN, 0, 1, 4, 5);
